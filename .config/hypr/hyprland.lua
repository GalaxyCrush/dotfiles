...
-- monitor = DP-2, 2560x1440@164.95799, 0x0, 1
...
-- https://wiki.hypr.land/Configuring/Basics/Variables/ for info about options
...
-- https://wiki.hypr.land/Configuring/Advanced-and-Cool/Animations/ for more
...
-- mainMod + Shift + setas -> move windows
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot -z --clipboard-only -m region"))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("hyprshot -z --clipboard-only -m window"))
